<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-2xl font-semibold mb-2" style="color: var(--text-primary)">Terms & Conditions</h1>
        <p style="color: var(--text-secondary)">Manage terms and conditions content</p>
      </div>
