<template>
  <div class="space-y-6">
    <div class="flex items-center space-x-4">
      ...
      <div>
        <h1 class="text-2xl font-semibold" style="color: var(--text-primary)">Add Specialization</h1>
        <p style="color: var(--text-secondary)">Create a new medical specialization</p>
      </div>
    </div>
    ...
    <form @submit.prevent="submitForm" class="card">
      ...
      <div class="flex justify-end space-x-3 mt-6 pt-6 border-t" style="border-color: var(--border-color)">
        ...
        <button type="submit" class="btn-primary">Add Specialization</button>
      </div>
    </form>
  </div>
</template>
