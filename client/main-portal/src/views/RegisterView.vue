    ...
    <div class="w-full flex overflow-hidden">
      ...
      <div class="flex-1 bg-white flex items-center justify-center p-10">
        <div class="w-full max-w-xs">
          ...
          <div class="mb-6">
            <h1 class="text-xl font-medium text-gray-900 mb-1">Create your account</h1>
            <p class="text-sm text-gray-400">Step 1 of 3 — set your login details.</p>
          </div>
          ...
          <form novalidate @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
              <label for="password" class="block text-xs font-medium uppercase tracking-wide text-gray-400 mb-1.5">Password</label>
              <input
                id="password"
...
async function handleSubmit() {
  ...
  try {
    ...
    router.push({ path: '/register', query: { step: 'patient-details' } })
  } catch (e) {
    error.value = e?.message || 'Could not continue. Please try again.'
  } finally {
    loading.value = false
  }
}
